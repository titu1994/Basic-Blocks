...
import com.somshubra.sort.HyperParallelQuickSort;

public class HyperParallelQuickSortTest {
	...
	public static void main(String[] args) {
		...
		HyperParallelQuickSort.sort(data);
		...
		// memory = runtime.totalMemory() - runtime.freeMemory();
		// System.out.println("Memory in MB Consumed : " + (memory / (1024 *
		// 1024)));
