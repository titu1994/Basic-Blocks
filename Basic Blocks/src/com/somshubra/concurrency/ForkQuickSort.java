...
public class ForkQuickSort {
    ...
    public static void main(String[] args) {
        ...
        int threshold = ParallelQuickSortTask.computeThreshold(data.length);

        ForkJoinPool pool = new ForkJoinPool();
        pool.invoke(new ParallelQuickSortTask(data, 0, data.length-1, threshold));
